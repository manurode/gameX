...
const DEFINITIONS: Dictionary = {
	...
	"mill": {
		...
		"blocks_nav": true,
		"visual_scale": 0.95,
		# Tower/base only for walk-block fallback; farm stays walkable via plot carve.
		"footprint": Vector2(110.0, 90.0),
		"pick_half_size": Vector2(122.0, 152.0),
		"gather_type": "food",
		"spawns_gather_source": true,
		"gather_radius_cells": 0,
		# Centered on the painted wheat plot in mill.png (stone-bordered field).
		"farm_offset": Vector2(0.0, -12.0),
		"farm_half_size": Vector2(74.0, 40.0),
